<x-jet-action-section>
    ...
    <x-slot name="description">
        {{ __('Administra y Cierra tus Sesiones Actuales en Otros Navegadores y Dispositivos.') }}
    </x-slot>
    ...
    <x-slot name="content">
        ...
        <x-jet-dialog-modal wire:model="confirmingLogout">
            ...
            <x-slot name="content">
                {{ __('Por Favor Ingrese su Contraseña para Confirmar que Quieres Cerrar la Session de los Otros Navegadores en Todos tus Dispositivos.') }}
